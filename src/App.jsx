...
function App() {
  return (
    <div className="App">
      <div className="App_title free_img">
        <img src="/img/title.webp" alt="" />
      </div>
      <div className='App_decorBallRight free_img'>
        <img src="/img/rightJackpot.webp" alt="" />
      </div>
      <div className='App_coinVolcano free_img'>
        <img src="/img/coinVolcano.webp" alt="" />
      </div>
      <div className='App_green free_img'>
        <GreenLabel />
      </div>
      <div className='App_table free_img'>
        <img src="/img/table.webp" alt="" />
      </div>
      <div className='App_btn free_img'>
        <Btn />
      </div>
